...
keyboards_UserCustom_dct = {
    ...
    'Keychron Keychron Q1 Max': 'Apple'
}
...
keymap("User VS Code overrides", {
    C("Super-Alt-c"): C("C-Alt-c"),
    C("Super-Alt-j"): C("C-Alt-j"),
    C("Super-Enter"): C("C-Enter"),
...
keymap("User terminal window controls", {
    # Physical Ctrl+Option+Cmd → native KWin shortcuts
    C("LC-RC-Alt-m"):     C("Super-Page_Up"),
    C("LC-RC-Alt-Left"):  C("Super-Left"),
    C("LC-RC-Alt-Right"): C("Super-Right"),
    C("LC-Up"): C("Super-Up"),
}, when=lambda ctx:
    cnfg.screen_has_focus and
    hmp_is_terminal(ctx)
